...
Prior pending: `glp1picks-research-cagrisema-approval-status` (high, filed 2026-07-06). Unverified Platinum Capital claim still unresolved after 6+ weeks. Standard NDA timeline (PDUFA ~Oct 2026) is credible baseline. Check FDA.gov press releases and Novo Nordisk IR before publishing any CagriSema approval content.

**UPDATE** glp1pets competitive landscape pages with Huadong Medicine pribopeptide filing: China's Huadong Medicine filed for MARA approval of pribopeptide, a dual GLP-1/GIP agonist for overweight cats, with Phase III data showing ~10% body weight loss in 6 weeks and 72% of cats losing >5% — first international competitor in the veterinary anti-obesity drug category. Source: Sixth Tone, Yicai Global.

## Strategic memo

**Mandatory opportunity pass:** no new revenue surface today. Huadong Medicine's pribopeptide validates the pet-obesity drug category globally but is a China-only filing with no US implications for now. The existing `pet-glp1-watch` opportunity (built as glp1pets.com) and `pet-peptide-safety-atlas` (proposed) remain the correct routing for pet-health signals.

**Existing opportunities:**
- `pet-peptide-safety-atlas` (proposed): PCAC July 23 remains the trigger. Monitor.
- `dog-longevity-tracker` (proposed): Akston dual-species program adds a second pipeline entity alongside LOY-002. No action today.
