  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "10,649", context: "30-day window" },
        { label: "Organic clicks", value: "184", context: "30-day window" },
        { label: "Affiliate clicks", value: "1770", context: "30-day window via Katalys" },
        { label: "Conversions", value: "4", context: "30-day window" },
        { label: "Affiliate payout", value: "$1,400", context: "30-day window" },
        { label: "EPC", value: "$0.79", context: "earnings per click" },
