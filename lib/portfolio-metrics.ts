  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "15,991", context: "30-day window" },
        { label: "Organic clicks", value: "304", context: "30-day window" },
        { label: "Affiliate clicks", value: "2053", context: "30-day window via Katalys" },
        { label: "Conversions", value: "9", context: "30-day window" },
        { label: "Affiliate payout", value: "$2,949", context: "30-day window" },
        { label: "EPC", value: "$1.44", context: "earnings per click" },
