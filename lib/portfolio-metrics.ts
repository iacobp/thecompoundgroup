  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "9,655", context: "30-day window" },
        { label: "Organic clicks", value: "98", context: "30-day window" },
        { label: "Affiliate clicks", value: "896", context: "30-day window via Katalys" },
