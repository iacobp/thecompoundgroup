  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "11,175", context: "30-day window" },
        { label: "Organic clicks", value: "59", context: "30-day window" },
        { label: "Affiliate clicks", value: "406", context: "30-day window via Katalys" },
        { label: "Conversions", value: "8", context: "30-day window" },
        { label: "Affiliate payout", value: "$1,846", context: "30-day window" },
        { label: "EPC", value: "$4.55", context: "earnings per click" },
