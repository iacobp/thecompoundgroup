  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "10,987", context: "30-day window" },
        { label: "Organic clicks", value: "87", context: "30-day window" },
        { label: "Affiliate clicks", value: "762", context: "30-day window via Katalys" },
        { label: "Conversions", value: "6", context: "30-day window" },
        { label: "Affiliate payout", value: "$1,581", context: "30-day window" },
        { label: "EPC", value: "$2.07", context: "earnings per click" },
