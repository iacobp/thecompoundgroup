  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "10,872", context: "30-day window" },
        { label: "Organic clicks", value: "57", context: "30-day window" },
        { label: "Affiliate clicks", value: "407", context: "30-day window via Katalys" },
        { label: "Conversions", value: "8", context: "30-day window" },
        { label: "Affiliate payout", value: "$1,846", context: "30-day window" },
        { label: "EPC", value: "$4.54", context: "earnings per click" },
