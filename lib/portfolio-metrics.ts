  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "10,923", context: "30-day window" },
        { label: "Organic clicks", value: "81", context: "30-day window" },
        { label: "Affiliate clicks", value: "725", context: "30-day window via Katalys" },
        { label: "Conversions", value: "6", context: "30-day window" },
        { label: "Affiliate payout", value: "$1,581", context: "30-day window" },
        { label: "EPC", value: "$2.18", context: "earnings per click" },
        { label: "Email subscribers", value: "39" },
      ],
      asOf: "2026-06-01",
