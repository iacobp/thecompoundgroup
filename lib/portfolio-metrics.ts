  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "9,638", context: "30-day window" },
        { label: "Organic clicks", value: "156", context: "30-day window" },
        { label: "Affiliate clicks", value: "1384", context: "30-day window via Katalys" },
        ...
        { label: "Email subscribers", value: "55" },
      ],
      asOf: "2026-06-30",
