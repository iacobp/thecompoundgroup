  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "30,835", context: "30-day window" },
        { label: "Organic clicks", value: "544", context: "30-day window" },
        { label: "Affiliate clicks", value: "3458", context: "30-day window via Katalys" },
        { label: "Conversions", value: "12", context: "30-day window" },
        { label: "Affiliate payout", value: "$3,549", context: "30-day window" },
        { label: "EPC", value: "$1.03", context: "earnings per click" },
