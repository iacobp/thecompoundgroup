  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "10,413", context: "30-day window" },
        { label: "Organic clicks", value: "52", context: "30-day window" },
        { label: "Affiliate clicks", value: "482", context: "30-day window via Katalys" },
        { label: "Conversions", value: "7", context: "30-day window" },
        { label: "Affiliate payout", value: "$1,546", context: "30-day window" },
        { label: "EPC", value: "$3.21", context: "earnings per click" },
