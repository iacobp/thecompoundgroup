  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "10,384", context: "30-day window" },
        { label: "Organic clicks", value: "183", context: "30-day window" },
        { label: "Affiliate clicks", value: "1693", context: "30-day window via Katalys" },
        { label: "Conversions", value: "4", context: "30-day window" },
        { label: "Affiliate payout", value: "$1,400", context: "30-day window" },
        { label: "EPC", value: "$0.83", context: "earnings per click" },
