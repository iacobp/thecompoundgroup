  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "12,766", context: "30-day window" },
        { label: "Organic clicks", value: "238", context: "30-day window" },
        { label: "Affiliate clicks", value: "1906", context: "30-day window via Katalys" },
        { label: "Conversions", value: "8", context: "30-day window" },
        { label: "Affiliate payout", value: "$2,649", context: "30-day window" },
        { label: "EPC", value: "$1.39", context: "earnings per click" },
