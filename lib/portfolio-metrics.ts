  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "18,069", context: "30-day window" },
        { label: "Organic clicks", value: "344", context: "30-day window" },
        { label: "Affiliate clicks", value: "2070", context: "30-day window via Katalys" },
        { label: "Conversions", value: "9", context: "30-day window" },
        { label: "Affiliate payout", value: "$2,949", context: "30-day window" },
        { label: "EPC", value: "$1.42", context: "earnings per click" },
        { label: "Email subscribers", value: "59" },
      ],
      asOf: "2026-07-16",
