  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "29,092", context: "30-day window" },
        { label: "Organic clicks", value: "509", context: "30-day window" },
        { label: "Affiliate clicks", value: "3278", context: "30-day window via Katalys" },
        { label: "Conversions", value: "12", context: "30-day window" },
        { label: "Affiliate payout", value: "$3,549", context: "30-day window" },
        { label: "EPC", value: "$1.08", context: "earnings per click" },
        { label: "Email subscribers", value: "62" },
      ],
      asOf: "2026-07-26",
