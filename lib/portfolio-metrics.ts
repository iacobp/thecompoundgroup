  ...
  properties: [
    {
      ...
      metrics: [
        ...
        { label: "Organic impressions", value: "14,495", context: "30-day window" },
        { label: "Organic clicks", value: "269", context: "30-day window" },
        { label: "Affiliate clicks", value: "1941", context: "30-day window via Katalys" },
        { label: "Conversions", value: "9", context: "30-day window" },
        { label: "Affiliate payout", value: "$2,949", context: "30-day window" },
        { label: "EPC", value: "$1.52", context: "earnings per click" },
