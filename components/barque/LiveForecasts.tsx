  ...
  return (
    ...
    >
      <div className="relative mx-auto max-w-[1320px] px-6 md:px-10">
        ...
        <Reveal>
          <h2 className="font-display text-ink text-[40px] md:text-[64px] lg:text-[72px] leading-[1.04] tracking-tightest mb-6 max-w-[24ch]">
            Predictions with{" "}
        ...
        <Reveal delay={120}>
          <p className="text-[16px] md:text-[18px] leading-[1.6] text-ink/70 max-w-[58ch] mb-16 md:mb-24">
          ...
          {forecasts.map((f, i) => {
            ...
            return (
              <Reveal key={f.id} delay={120 * i}>
                <article className="group grid grid-cols-12 gap-4 md:gap-8 py-8 md:py-10 border-t border-ink/10 transition-colors hover:border-ink/30">
                  <div className="col-span-12 md:col-span-2">
                    <div className="font-display italic text-sage-soft text-[14px] md:text-[16px]">
                      {String(i + 1).padStart(2, "0")}
                    </div>
                    <div className="text-[11px] uppercase tracking-[0.22em] text-ink/50 mt-2">
                      {domainLabel[f.domain] ?? f.domain}
                    </div>
                  </div>

                  <div className="col-span-12 md:col-span-6">
                    <div className="text-[13px] uppercase tracking-[0.2em] text-ink/45 mb-2">
                      {f.entity}
                    </div>
                    <p className="font-display text-[22px] md:text-[28px] leading-[1.2] text-ink tracking-snug max-w-[44ch]">
                      {f.prediction}
                    </p>
                    <p className="mt-4 text-[13px] md:text-[14px] leading-[1.6] text-ink/60 max-w-[52ch]">
                      {f.notes}
                    </p>
                  </div>
                  ...
                  <div className="col-span-6 md:col-span-2">
                    ...
                    <div className="font-display text-ink text-[44px] md:text-[56px] leading-none tracking-tightest mt-2">
                      {Math.round(f.probability * 100)}
                      <span className="text-[20px] md:text-[22px] text-ink/55 align-top ml-1">
                        %
                      </span>
                    </div>
                  ...
                  <div className="col-span-6 md:col-span-2 md:text-right">
                    ...
                    <div className="font-display text-ink text-[22px] md:text-[24px] leading-tight tracking-snug mt-2">
